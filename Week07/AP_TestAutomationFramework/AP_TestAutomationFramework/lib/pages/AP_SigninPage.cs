...
namespace AP_TestAutomationFramework.lib.pages
{
    ...
    {
        // Create a class for each Page you want to test.
        // In one test you can create a customer journey from sign-in to product purchase.
        ...
        public void InputSigninCredentials(Credentials credentials)
        {
            ...
            InputPasswordLogin(credentials.Password);
        }
        #endregion
    }
}
