...
Testing the features of the Checkout: Overview page

@HappyPath
Scenario: 1.1.9 View products I am purchasing
	Given I am Logged in
	When I am on checkout overview with products in the cart
	Then I can see the products "<productName>" I am purchasing
	Examples: 
	| productName         |
	| Sauce Labs Backpack |

@HappyPath
Scenario: 1.1.10 Have the correct Total price displayed before and after Tax
	Given I am Logged in
	When I am on checkout overview with products in the cart
